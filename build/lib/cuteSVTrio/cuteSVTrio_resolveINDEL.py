...
def resolution_DEL(path, chr, read_count, threshold_gloab, max_cluster_bias,
    ...
    ********************************************************************************************
    ...
    #    if candidate_single_SV_gt_fam_ls[0][i][0] == "1" and int(candidate_single_SV_gt_fam_ls[0][i][2]) > 9742 and int(candidate_single_SV_gt_fam_ls[0][i][2]) < 10742:
    ...
    '''
    #for i in range(len(candidate_single_SV_gt_fam_ls[0])) :
    #    if candidate_single_SV_gt_fam_ls[0][i][0] == "1" and int(candidate_single_SV_gt_fam_ls[0][i][2]) >= 236549087 and int(candidate_single_SV_gt_fam_ls[0][i][2]) <= 236549087:
    #    #if candidate_single_SV_gt_fam_ls[0][i][0] == "chr1" and int(candidate_single_SV_gt_fam_ls[0][i][2]) == 180218 :
    ...
    #for i in range(len(candidate_single_SV_gt_fam_ls[0])) :
        #if candidate_single_SV_gt_fam_ls[0][i][0] == "19" and int(candidate_single_SV_gt_fam_ls[0][i][2]) > 10000 and int(candidate_single_SV_gt_fam_ls[0][i][2]) < 100000:
        #if candidate_single_SV_gt_fam_ls[0][i][0] == "19" and int(candidate_single_SV_gt_fam_ls[0][i][2]) > 10000 and int(candidate_single_SV_gt_fam_ls[0][i][2]) < 100000:
    #        logging.info("%s/%s/%s"%(str(candidate_single_SV_gt_fam_ls[0][i]),str(candidate_single_SV_gt_fam_ls[1][i]),str(candidate_single_SV_gt_fam_ls[2][i])))
...
def resolution_INS(path, chr, read_count, threshold_gloab, 
    ...
    ********************************************************************************************
            ...
            if len(semi_ins_cluster) >= read_count:
                if semi_ins_cluster[-1][0] == semi_ins_cluster[-1][1] == 0:
                    ...
                    for semi_ins_cluster_new in semi_ins_cluster_ls :
                        ...
                        #if semi_ins_cluster[-1][0] >= 158995120 and semi_ins_cluster[-1][0] <= 158996120 :
                        #    logging.info(semi_ins_cluster_new)
    ...
    '''
    #for i in range(len(candidate_single_SV_fam_ls[0])) :
    #    if candidate_single_SV_fam_ls[0][i][0] == "1" and int(candidate_single_SV_fam_ls[0][i][2]) > 9742 and int(candidate_single_SV_fam_ls[0][i][2]) < 10742:
    ...
    #for i in range(len(candidate_single_SV_fam_ls[0])) :
    #    if candidate_single_SV_fam_ls[0][i][0] == "7" and int(candidate_single_SV_fam_ls[0][i][2]) >= 158995120 and int(candidate_single_SV_fam_ls[0][i][2]) <= 158996120:
    #        logging.info("%s/%s/%s"%(str(candidate_single_SV_fam_ls[0][i]),str(candidate_single_SV_fam_ls[1][i]),str(candidate_single_SV_fam_ls[2][i])))
    ...
    #for i in range(len(candidate_single_SV_gt_fam_ls[0])) :
    #    if candidate_single_SV_gt_fam_ls[0][i][0] == "9" and int(candidate_single_SV_gt_fam_ls[0][i][2]) == 110539758:
    #        logging.info("%s/%s/%s"%(str(candidate_single_SV_gt_fam_ls[0][i]),str(candidate_single_SV_gt_fam_ls[1][i]),str(candidate_single_SV_gt_fam_ls[2][i])))
    ...
    #    logging.info("%s/%s/%s"%(str(candidate_single_SV_gt_fam_ls[0][i]),str(candidate_single_SV_gt_fam_ls[1][i]),str(candidate_single_SV_gt_fam_ls[2][i])))
    #for i in range(len(candidate_single_SV_gt_fam_ls[0])) :
    #    if chr == "chr2" and int(candidate_single_SV_gt_fam_ls[0][i][2]) > 109198995 and int(candidate_single_SV_gt_fam_ls[0][i][2]) < 109199995:
    #        logging.info("%s/%s/%s"%(str(candidate_single_SV_gt_fam_ls[0][i]),str(candidate_single_SV_gt_fam_ls[1][i]),str(candidate_single_SV_gt_fam_ls[2][i])))
    #check_gt_consistent(candidate_single_SV_gt_fam_ls)
