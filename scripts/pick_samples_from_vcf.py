...
# 这个样本列表是从1kGP_chr1_SV.15.target.vcf.gz中随机提取出来的
...
def main(argv):
    pick_samples_from_vcf("merge.truvari.rectified.chr1.vcf.gz".replace("chr1",argv[0]),"cuteSVTrio.chr1.overlap.sv.vcf".replace("chr1",argv[0]),cuteSVTrio_1kgp_member_ls,cuteSVTrio_1kgp_member_ls)
    pick_samples_from_vcf("1kGP_chr1_SNP_INDEL.vcf.gz".replace("chr1",argv[0]),"1kGP.chr1.overlap.SNP_INDEL.vcf".replace("chr1",argv[0]),cuteSVTrio_1kgp_member_ls,cuteSVTrio_1kgp_member_ls)
    pick_samples_from_vcf("merge.truvari.rectified.chr1.vcf.gz".replace("chr1",argv[0]),"HGSVC.chr1.overlap.sv.vcf".replace("chr1",argv[0]),HGSVC_1kgp_member_ls,HGSVC_1kgp_member_ls)
    pick_samples_from_vcf("1kGP_chr1_SNP_INDEL.vcf.gz".replace("chr1",argv[0]),"1kGP.chr1.overlap.SNP_INDEL.vcf".replace("chr1",argv[0]),HGSVC_1kgp_member_ls,HGSVC_1kgp_member_ls)
    pick_samples_from_vcf("1kGP_chr1_SNP_INDEL.vcf.gz".replace("chr1",argv[0]),"1kGP_chr1_SNP_INDEL.260.target.vcf".replace("chr1",argv[0]),target_member_ls,target_member_ls)
